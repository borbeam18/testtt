...
<aside class="sidebar w-64 text-white flex flex-col fixed h-screen overflow-y-auto scrollbar-thin">
  ...
  <nav class="flex-1 p-3 space-y-1">
    <a href="/testtt/owner/dashboard.php" class="nav-item <?= $activePage==='dashboard'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg">📊 Dashboard</a>
    <a href="/testtt/owner/calendar.php" class="nav-item <?= $activePage==='calendar'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg">📅 ปฏิทินนัดหมาย</a>
    <a href="/testtt/owner/jobs.php" class="nav-item <?= $activePage==='jobs'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg">📋 คำขอรับบริการ</a>
    <a href="/testtt/owner/payment.php" class="nav-item <?= $activePage==='payment'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg">💰 ตรวจสอบการชำระเงิน</a>
    <a href="/testtt/owner/services.php" class="nav-item <?= $activePage==='services'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg">⚙️ ประเภทงานบริการ</a>
    <a href="/testtt/owner/customers.php" class="nav-item <?= $activePage==='customers'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg"> ข้อมูลลูกค้า</a>
    <a href="/testtt/owner/expenses.php" class="nav-item <?= $activePage==='expenses'?'active':'' ?> flex items-center gap-3 px-4 py-3 rounded-lg">💵 รายรับ-รายจ่าย</a>
  </nav>
  <div class="p-3 border-t border-white/10">
    <a href="/testtt/user/profile.php" class="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 transition text-white/80">👤 ข้อมูลส่วนตัว</a>
    <a href="/testtt/user/change_password.php" class="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 transition text-white/80">🔑 เปลี่ยนรหัสผ่าน</a>
    <a href="/testtt/api/logout.php" class="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 transition text-white/80">🚪 ออกจากระบบ</a>
  </div>
</aside>
