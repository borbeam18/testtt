...
<header class="bg-blue-900 px-6 py-4 text-white shadow">
  <div class="mx-auto flex max-w-5xl items-center justify-between">
    ...
    <a href="/testtt/api/logout.php" class="rounded-lg bg-red-500 px-4 py-2 text-sm font-semibold hover:bg-red-600">ออกจากระบบ</a>
  </div>
</header>
...
<main class="mx-auto max-w-5xl p-6">
  ...
  <div class="grid gap-5 md:grid-cols-3">
    <a href="/testtt/user/profile.php" class="rounded-2xl bg-white p-6 shadow hover:shadow-lg">
      <div class="mb-2 text-2xl">👤</div>
      <h2 class="font-bold text-slate-800">ข้อมูลส่วนตัว</h2>
      <p class="text-sm text-slate-500">ดูและแก้ไขข้อมูลของคุณ</p>
    </a>
    <a href="/testtt/user/change_password.php" class="rounded-2xl bg-white p-6 shadow hover:shadow-lg">
      <div class="mb-2 text-2xl">🔑</div>
      <h2 class="font-bold text-slate-800">เปลี่ยนรหัสผ่าน</h2>
      <p class="text-sm text-slate-500">ตั้งรหัสผ่านใหม่ของคุณ</p>
    </a>
    <a href="/testtt/api/logout.php" class="rounded-2xl bg-white p-6 shadow hover:shadow-lg">
      <div class="mb-2 text-2xl">🚪</div>
