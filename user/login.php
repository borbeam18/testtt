...
if (isset($_SESSION['role'])) {
    $redirect = match($_SESSION['role']) {
        ...
        'technician' => '/testtt/technician/dashboard.php',
        'customer'   => '/testtt/customer/dashboard.php',
        default      => '/testtt/user/login.php',
    };
  ...
  <div class="login-card w-full max-w-md p-8 fade-in">
    ...
    <form id="loginForm" class="space-y-4">
      ...
      <div class="text-center pt-3 border-t border-slate-200">
        <p class="text-sm text-slate-600">ยังไม่มีบัญชี? <a href="/testtt/user/register.php" class="text-blue-900 font-semibold hover:underline">สมัครสมาชิก</a></p>
      </div>
    </form>
  </div>
