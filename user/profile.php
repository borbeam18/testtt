...
<div class="bg-white w-full max-w-lg rounded-2xl shadow-lg p-8">
  <div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= $role === 'admin' ? '/testtt/admin/users.php' : '/testtt/owner/dashboard.php' ?>" class="text-sm text-blue-900 hover:underline">กลับหน้าหลัก</a>
  </div>
  <?php if ($message): ?>
  ...
  <form method="POST" class="space-y-4">
    ...
    <div class="flex justify-end gap-3 border-t border-slate-200 pt-4">
      <a href="/testtt/user/change_password.php" class="rounded-lg border border-slate-300 px-4 py-3 text-slate-700 hover:bg-slate-50">เปลี่ยนรหัสผ่าน</a>
