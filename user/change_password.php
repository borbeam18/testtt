...
<div class="bg-white w-full max-w-lg rounded-2xl shadow-lg p-8">
  <div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= $user['role'] === 'admin' ? '/testtt/admin/users.php' : ($user['role'] === 'customer' ? '/testtt/user/login.php' : '/testtt/owner/dashboard.php') ?>" class="text-sm text-blue-900 hover:underline">กลับหน้าหลัก</a>
  </div>
  <?php if ($message): ?>
