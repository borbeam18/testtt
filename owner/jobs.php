...
<div class="card p-6">
  <form method="GET" class="flex items-center justify-between mb-5 flex-wrap gap-3">
    ...
    <a href="/testtt/owner/calendar.php" class="btn-accent px-4 py-2 rounded-lg text-sm font-semibold no-underline">+ สร้างงานใหม่</a>
  </form>
  <div class="overflow-x-auto">
    <table class="w-full data-table">
      ...
      <?php foreach ($jobs as $j): ?>
        <tr class="hover:bg-slate-50 cursor-pointer" onclick="location.href='/testtt/owner/job_detail.php?id=<?= $j['booking_id'] ?>'">
