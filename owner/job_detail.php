...
if (!$bookingId) { header('Location: /testtt/owner_jobs.php'); exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'update_status') {
    ...
    header('Location: /testtt/owner/job_detail.php?id=' . $bookingId);
    exit;
}
...
<div class="mb-4 flex items-center justify-between flex-wrap gap-3">
  ...
  <div class="flex items-center gap-2">
    <a href="/testtt/owner_jobs.php" class="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">← ย้อนกลับ</a>
